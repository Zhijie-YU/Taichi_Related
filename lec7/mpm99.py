import taichi as ti
import numpy as np
ti.init(debug=True, arch=ti.cpu) # Try to run on GPU
quality = 1 # Use a larger value for higher-res simulations
n_particles, n_grid = 9 * quality ** 2, 128 * quality
  ...
  for p in x: # Particle state update and scatter to grid (P2G)
    ...
    for d in ti.static(range(2)):
      ...
      if material[p] == 2:  # Snow
        # for snow, too large deformation is clamped. (elastoplastic)
    ...
    # Corotated hyperelastic is used here for elastic part.
